const FoodData = [
    ...
    },
    {
      ...
      price: 100,
      desc: "Classic chocolate chip cookies made with rich, buttery dough and loaded with chunks of semisweet chocolate. A timeless treat that's perfect for any occasion.",
      category: "Snacks",
      rating: 4.7,
    },
    {
      ...
      name: "Nachos",
      price: 110,
      desc: "Crispy tortilla chips topped with melted cheese, jalapenos, sour cream, and salsa. A crowd-pleasing snack that's great for sharing.",
      category: "Snacks",
      rating: 4.2,
    },
    {
      ...
      name: "Popcorn",
      price: 120,
      desc: "Freshly popped popcorn seasoned with butter and salt. A classic movie snack that's addictive and satisfying.",
      category: "Snacks",
      rating: 4.5,
    },
    {
      ...
      price: 130,
      desc: "Golden brown mozzarella sticks breaded and fried to crispy perfection. Served with marinara sauce for dipping. A delicious appetizer or snack.",
      category: "Snacks",
      rating: 4.3,
    },
    {
      ...
      name: "Fried Calamari",
      price: 140,
      desc: "Tender rings of calamari coated in seasoned batter and fried until crispy. Served with marinara sauce and lemon wedges. A popular seafood appetizer.",
      category: "Snacks",
      rating: 4.6,
    },
    {
      ...
      price: 150,
      desc: "Grilled flour tortilla filled with seasoned chicken, melted cheese, and sautéed onions and peppers. Served with salsa and sour cream. A tasty Tex-Mex snack.",
      category: "Snacks",
      rating: 4.8,
    },
    {
      ...
      name: "Hummus Platter",
      price: 160,
      desc: "Creamy hummus served with pita bread, carrot sticks, cucumber slices, and olives. A healthy and flavorful snack option.",
      category: "Snacks",
      rating: 4.9,
    },
    {
      ...
      price: 170,
      desc: "Fresh jalapeno peppers stuffed with cream cheese, wrapped in bacon, and baked until crispy. A spicy and indulgent snack that's sure to please.",
      category: "Snacks",
      rating: 4.1,
    },
    {
      ...
      name: "Garlic Bread",
      price: 180,
      desc: "Sliced French bread topped with garlic butter and toasted until golden brown. A simple yet satisfying snack or side dish.",
      category: "Snacks",
      rating: 4.4,
    },
    {
      ...
      name: "Fruit Smoothie",
      price: 190,
      desc: "A refreshing blend of fresh fruit, yogurt, and honey blended until smooth. A nutritious and delicious snack or breakfast option.",
      category: "Snacks",
      rating: 4.0,
    },
  ];
